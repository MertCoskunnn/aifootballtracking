...
import { processRange, setMoveNetEnabled, getVisionStats } from './vision.js?v=31';
import { candidateWindows } from './scan.js?v=31';
import { collectKicks, analyzeKick } from './analysis.js?v=31';
