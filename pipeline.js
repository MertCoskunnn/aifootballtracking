...
import { processRange, setMoveNetEnabled, getVisionStats } from './vision.js?v=23';
import { candidateWindows } from './scan.js?v=23';
import { collectKicks, analyzeKick } from './analysis.js?v=23';
