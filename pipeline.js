...
import { processRange, setMoveNetEnabled, getVisionStats } from './vision.js?v=35';
import { candidateWindows } from './scan.js?v=35';
import { collectKicks, analyzeKick } from './analysis.js?v=35';
