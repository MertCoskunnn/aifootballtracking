...
import { findKicks, classifyView, suggestMode } from './detect.js?v=31';
import { detectMovingBall } from './context.js?v=31';
import { buildTrack, measure, measureFreeKick } from './metrics.js?v=31';
import { evaluate } from './coach.js?v=31';
import { assessKickQuality } from './quality.js?v=31';
