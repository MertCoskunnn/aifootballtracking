...
import { processRange, setMoveNetEnabled, getVisionStats } from './vision.js?v=26';
import { candidateWindows } from './scan.js?v=26';
import { collectKicks, analyzeKick } from './analysis.js?v=26';
