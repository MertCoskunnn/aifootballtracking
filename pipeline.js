...
import { processRange, setMoveNetEnabled, getVisionStats } from './vision.js?v=43';
import { candidateWindows } from './scan.js?v=43';
import { collectKicks, analyzeKick } from './analysis.js?v=43';
