...
import { processRange, setMoveNetEnabled, getVisionStats } from './vision.js?v=34';
import { candidateWindows } from './scan.js?v=34';
import { collectKicks, analyzeKick } from './analysis.js?v=34';
