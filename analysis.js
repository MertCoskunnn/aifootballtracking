...
import { findKicks, classifyView, suggestMode } from './detect.js?v=39';
import { detectMovingBall } from './context.js?v=39';
import { buildTrack, measure, measureFreeKick } from './metrics.js?v=39';
import { evaluate } from './coach.js?v=39';
import { assessKickQuality } from './quality.js?v=39';
