...
import { processRange, setMoveNetEnabled, getVisionStats } from './vision.js?v=32';
import { candidateWindows } from './scan.js?v=32';
import { collectKicks, analyzeKick } from './analysis.js?v=32';
