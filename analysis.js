...
import { findKicks, classifyView, suggestMode } from './detect.js?v=40';
import { detectMovingBall } from './context.js?v=40';
import { buildTrack, measure, measureFreeKick } from './metrics.js?v=40';
import { evaluate } from './coach.js?v=40';
import { assessKickQuality } from './quality.js?v=40';
