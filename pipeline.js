...
import { processRange, setMoveNetEnabled, getVisionStats } from './vision.js?v=40';
import { candidateWindows } from './scan.js?v=40';
import { collectKicks, analyzeKick } from './analysis.js?v=40';
