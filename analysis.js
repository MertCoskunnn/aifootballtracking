...
import { findKicks, classifyView, suggestMode } from './detect.js?v=28';
import { detectMovingBall } from './context.js?v=28';
import { buildTrack, measure, measureFreeKick } from './metrics.js?v=28';
import { evaluate } from './coach.js?v=28';
import { assessKickQuality } from './quality.js?v=28';
