...
import { findKicks, classifyView, suggestMode } from './detect.js?v=30';
import { detectMovingBall } from './context.js?v=30';
import { buildTrack, measure, measureFreeKick } from './metrics.js?v=30';
import { evaluate } from './coach.js?v=30';
import { assessKickQuality } from './quality.js?v=30';
