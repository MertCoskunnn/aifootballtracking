...
import { processRange, setMoveNetEnabled, getVisionStats } from './vision.js?v=30';
import { candidateWindows } from './scan.js?v=30';
import { collectKicks, analyzeKick } from './analysis.js?v=30';
