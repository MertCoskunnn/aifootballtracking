...
import { findKicks, classifyView, suggestMode } from './detect.js?v=29';
import { detectMovingBall } from './context.js?v=29';
import { buildTrack, measure, measureFreeKick } from './metrics.js?v=29';
import { evaluate } from './coach.js?v=29';
import { assessKickQuality } from './quality.js?v=29';
