...
import { processRange, setMoveNetEnabled, getVisionStats } from './vision.js?v=39';
import { candidateWindows } from './scan.js?v=39';
import { collectKicks, analyzeKick } from './analysis.js?v=39';
