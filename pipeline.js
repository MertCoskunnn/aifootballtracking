...
import { processRange, setMoveNetEnabled, getVisionStats } from './vision.js?v=44';
import { candidateWindows } from './scan.js?v=44';
import { collectKicks, analyzeKick } from './analysis.js?v=44';
