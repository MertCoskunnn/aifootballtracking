...
import { processRange, setMoveNetEnabled, getVisionStats } from './vision.js?v=41';
import { candidateWindows } from './scan.js?v=41';
import { collectKicks, analyzeKick } from './analysis.js?v=41';
