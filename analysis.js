...
import { findKicks, classifyView, suggestMode } from './detect.js?v=43';
import { detectMovingBall } from './context.js?v=43';
import { buildTrack, measure, measureFreeKick } from './metrics.js?v=43';
import { evaluate } from './coach.js?v=43';
import { assessKickQuality } from './quality.js?v=43';
