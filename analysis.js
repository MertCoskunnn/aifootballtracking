...
import { findKicks, classifyView, suggestMode } from './detect.js?v=55';
import { detectMovingBall } from './context.js?v=55';
import { buildTrack, measure, measureFreeKick } from './metrics.js?v=55';
import { evaluate } from './coach.js?v=55';
import { assessKickQuality } from './quality.js?v=55';
