...
import { findKicks, classifyView, suggestMode } from './detect.js?v=37';
import { detectMovingBall } from './context.js?v=37';
import { buildTrack, measure, measureFreeKick } from './metrics.js?v=37';
import { evaluate } from './coach.js?v=37';
import { assessKickQuality } from './quality.js?v=37';
