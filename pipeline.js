...
import { processRange, setMoveNetEnabled, getVisionStats } from './vision.js?v=22';
import { candidateWindows } from './scan.js?v=22';
import { collectKicks, analyzeKick } from './analysis.js?v=22';
