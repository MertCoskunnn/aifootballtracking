...
import { processRange, setMoveNetEnabled, getVisionStats } from './vision.js?v=37';
import { candidateWindows } from './scan.js?v=37';
import { collectKicks, analyzeKick } from './analysis.js?v=37';
