...
import { processRange, setMoveNetEnabled, getVisionStats } from './vision.js?v=36';
import { candidateWindows } from './scan.js?v=36';
import { collectKicks, analyzeKick } from './analysis.js?v=36';
