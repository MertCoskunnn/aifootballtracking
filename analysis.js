...
import { findKicks, classifyView, suggestMode } from './detect.js?v=32';
import { detectMovingBall } from './context.js?v=32';
import { buildTrack, measure, measureFreeKick } from './metrics.js?v=32';
import { evaluate } from './coach.js?v=32';
import { assessKickQuality } from './quality.js?v=32';
