...
import { findKicks, classifyView, suggestMode } from './detect.js?v=22';
import { detectMovingBall } from './context.js?v=22';
import { buildTrack, measure, measureFreeKick } from './metrics.js?v=22';
