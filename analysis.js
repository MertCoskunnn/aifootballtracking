...
import { findKicks, classifyView, suggestMode } from './detect.js?v=41';
import { detectMovingBall } from './context.js?v=41';
import { buildTrack, measure, measureFreeKick } from './metrics.js?v=41';
import { evaluate } from './coach.js?v=41';
import { assessKickQuality } from './quality.js?v=41';
